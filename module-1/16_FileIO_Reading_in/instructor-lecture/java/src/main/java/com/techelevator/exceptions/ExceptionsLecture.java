...
public class ExceptionsLecture {
	...
	private double calculateHotelRoomCharges(int nights, int numberOfGuests) throws SteveException{
		...
		if(nights < 1) {
			throw new SteveException("Minimum number of nights is 1", "I'm a dummy!", 100);
