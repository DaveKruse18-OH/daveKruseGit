...
/api/students/filter  	(GET)
	...
	Required Parameters:
    cohort     =   Gets a list of all students by cohort name
     
    Usage example: 	/api/students/filter?cohort=12
    
	Optional Parameters:
	sectionName    =   Gets a list of all students by section
	Usage example: 	/api/students/filter?cohort=12&section=green

    Optional lastName = Gets a list of students by last name
    Usage example: 	/api/students/filter?cohort=12&lastName=smith
	...
	*/	
	...
	public List<Student> searchStudents(@RequestParam String cohortName,@RequestParam(required=false) String sectionName, @RequestParam(required=false) String lastName) {
